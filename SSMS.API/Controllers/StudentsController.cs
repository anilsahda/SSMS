...
namespace SSMS.API.Controllers
{
    ...
    public class StudentsController : ControllerBase
    {
        ...
        public IActionResult AddImageUpload([FromBody] StudentDTO studentdto)
        {
            var student = new Student
            {
                FirstName = studentdto.FirstName,
        ...
        [HttpPut("UpdateImageUpload/{id}")]
        public IActionResult UpdateImageUpload(int id, [FromBody] StudentDTO studentdto)
        {
            var student = _context.Students.Find(id);
            if (student == null)
            {
